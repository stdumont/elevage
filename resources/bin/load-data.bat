...
D:\Tools\Xampp\mysql\bin\mysql.exe -u root --password="" elevage <D:\Projets\Sources\elevage\resources\sql\07-chiens.sql
D:\Tools\Xampp\mysql\bin\mysql.exe -u root --password="" elevage <D:\Projets\Sources\elevage\resources\sql\08-clients.sql
D:\Tools\Xampp\mysql\bin\mysql.exe -u root --password="" elevage <D:\Projets\Sources\elevage\resources\sql\09-typedocs.sql