angular.module('elevageApp').controller('calculDatesController', ['$scope', '$route', '$http', '$timeout', '$interval', function($scope, $route, $http, $timeout, $interval) {
    ...
    $scope.calcul_1_date_depart = moment().format('DD/MM/YYYY');
    $scope.calcul_1_nombre = 57;
    $scope.calcul_1_date_resultat = null;

    $scope.calcul_2_date_debut = moment().format('DD/MM/YYYY');
    $scope.calcul_2_date_fin = moment().format('DD/MM/YYYY');
