 ...
 */
define("DB_USER", 'rubis1021844');
define("DB_PASSWORD", 'fbhnjuw9tx');
define("DB_NAME", 'rubis1021844');
define("DB_HOST", '91.216.107.162');
define("BACKUP_DIR", 'resources/database-backup'); // Comment this line to use same script's directory ('.')
